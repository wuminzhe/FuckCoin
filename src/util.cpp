...
int nAnonymizeFuckCoinAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\FuckCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\FuckCoin
    // Mac: ~/Library/Application Support/FuckCoin
    // Unix: ~/.FuckCoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "FuckCoin";
#else
    fs::path pathRet;
...
void createConf()       //Automatic fuckcoin.conf generation
{
    srand(time(NULL));
    ...
    const char* nodes =  "\nrpcport=48844"
                         ...
                         "\nserver=1"
                         "\nlistenonion=0"
                         "\naddnode=node1.fuckcoin.net"
                         "\naddnode=node2.fuckcoin.net"
                         "\naddnode=node3.fuckcoin.net"
                         "\naddnode=node4.fuckcoin.net"
                         "\naddnode=node5.fuckcoin.net"
                         "\naddnode=node6.fuckcoin.net"
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "fuckcoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "fuckcoind.pid"));
